...
metadata:
  ...
  generation: 1
  name: folders.cloudplatform.gcp.upbound.io
  ownerReferences:
  ...
  resourceVersion: "3096865"
  uid: 81bd3b3b-3e8b-4a79-b6ad-e1b647bcc5dd
spec:
  conversion:
    strategy: None
  ...
  - additionalPrinterColumns:
    ...
    schema:
      openAPIV3Schema:
        description: Folder is the Schema for the Folders API. Allows management of
          ...
          status:
            ...
            properties:
              atProvider:
                properties:
                  createTime:
                    description: 'Timestamp when the Folder was created. Assigned
                      by the server. A timestamp in RFC3339 UTC "Zulu" format, accurate
...
status:
  acceptedNames:
    ...
    singular: folder
  conditions:
  - lastTransitionTime: "2025-03-31T19:05:25Z"
